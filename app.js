...
(function () {
  ...
  var FLAGS = {
    ...
    "--revision": "Exact model or tokenizer revision to load; pin this for reproducible measurements.",
    ...
    "--moe-runner-backend": "Kernel runner for routed and shared MoE experts.",
    ...
    "--linear-attn-backend": "Kernel backend for linear-attention layers such as KDA.",
    ...
    "--cuda-graph-backend-decode": "Decode graph mode; `full` captures the complete decode step.",
    "--cuda-graph-backend-prefill": "Prefill graph mode; `disabled` keeps variable-shape prefill eager.",
    "--cuda-graph-bs-decode": "Exact decode batch sizes captured into HIP/CUDA graphs.",
